...
### CTR and Patient Metadata 
Utilizing the model's computed CTR along with the patient's metadata, we wanted to provided a diagnosis. The patient's metadata includes gender, ethnicity, and age, which we selected to consider as they appear to be the most effective indictaors of cardiothoracic health.
